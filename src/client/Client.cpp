...
int run_client(int argc, char *argv[])
{
	...
	try
	{
		...
		/* OUT */
		MessageModuleOUT *out_module = new MessageModuleOUT();
		...
		/* IN */
		MessageModuleIN *in_module = new MessageModuleIN(out_module->getUDPsocket());
		...
		/* CLIENT ACTIONS */
		ClientActionModule *action_module = new ClientActionModule(&client_data);
		if ( action_module == NULL ) throw "Cannot create action module";
		action_module->setInQueue(in_module->getQueue());
		action_module->setOutQueue(out_module->getQueue());
